...
def generate_vehicle_data():
    ...
    return jsonify({"status": "success", "message": "Vehicle data generation started successfully."})
...
def generate_user_data():
    ...
    return jsonify({"status": "success", "message": "User data generation started successfully."})
