...
if selected_viaje == "General":
    ...
    for viaje_id in viaje_ids:
        ...
        folium.Marker(location=inicio_viaje, icon=folium.Icon(color="green"), popup=f"Inicio Viaje {viaje_id}").add_to(m)
        folium.Marker(location=final_viaje, icon=folium.Icon(color="red"), popup=f"Final Viaje {viaje_id}").add_to(m)
    ...
    icono_coche = folium.CustomIcon(icon_image="streamlit/toro-coche.png", icon_size=(32, 32))
